...
<div class="container"> 
  ...
  <section class="intro">
    <div class="column">
      ...
      <img src="<?php echo'https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/champion-icons/'.$user_data["main"].'.png'; ?>" alt="" style="border-radius:100%" class="profile"> </div>
    <div class="column">
      <p>DESCRIPCION</p>
    </div>
  </section>
